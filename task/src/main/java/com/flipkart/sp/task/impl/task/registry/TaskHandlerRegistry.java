...
package com.flipkart.sp.task.impl.task.registry;
...
public class TaskHandlerRegistry {
	...
	/**
	 * Helper method to initialize poolToThreadPoolSize from {@link com.flipkart.sp.task.spi.task.TaskHandler#getInitializationCommands()} ()}
	 * and {@link com.flipkart.sp.task.spi.task.HystrixTaskHandler#getThreadPoolSizeParams()}
	 */
