...
/**
 * <code>ThriftProxyExecutor</code> is an extension of {@link HystrixCommand}. It is essentially a 
...
public class ThriftProxyExecutor extends HystrixCommand<TTransport> {
	...
	/**
	 * Helper method that constructs the {@link Setter} according to the properties set in the {@link ThriftProxy}.
